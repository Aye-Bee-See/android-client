...
object NetworkModule {
  ...
  @Provides
  @Singleton
  fun notificationsApi(retrofit: Retrofit): me.paxana.abcmailbox.data.api.NotificationsApi = retrofit.create(me.paxana.abcmailbox.data.api.NotificationsApi::class.java)
